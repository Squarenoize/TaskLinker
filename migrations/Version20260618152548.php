 ...
 */
final class Version20260618152548 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project CHANGE starting_date starting_date DATE DEFAULT NULL, CHANGE deadline_date deadline_date DATE DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project CHANGE starting_date starting_date DATE NOT NULL, CHANGE deadline_date deadline_date DATE NOT NULL');
