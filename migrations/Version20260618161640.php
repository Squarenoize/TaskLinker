 ...
 */
final class Version20260618161640 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task CHANGE deadline_date deadline_date DATE DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task CHANGE deadline_date deadline_date DATE NOT NULL');
